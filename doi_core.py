...
# Off by default - Crossref needs no key and no identification. Only set this
# if you start seeing throttling on long lists; it moves requests into their
# "polite pool". Nothing is sent anywhere else.
EMAIL = ""
